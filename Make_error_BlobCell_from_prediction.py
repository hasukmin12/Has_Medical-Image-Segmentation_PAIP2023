    ...
    with torch.no_grad():
        for img_name in img_names:
            if img_name != 'Thumbs.db':
                ...
                # make error label
                cv2.imwrite(join(args.error_label_path, 'case_' + img_name.split('_')[-1]), rst*255)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_Cell_only_StainNorm_r10_with_MONAI_Just_Cell_BlobCell') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task701_Lunit_Cell_only/For_inference/imagesTr') # Task701_Lunit_Cell_only/For_inference/imagesTs  
    parser.add_argument('-o', dest='aim_path', default="Final_Lunit_JustCell_StainNorm_DL_se_ResNext_b8_BlobCell_e5.2k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_best_e05200_dice0.7388840360945143.pth') # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
    parser.add_argument('-f_gt', dest='folder_to_inference', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task747_Lunit_Cell_StainNorm_BlobCell_JustCell/labelsTr')
    ...
    args.error_label_path = '/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/error_cell_prediction/labelsTr'
    os.makedirs(args.error_label_path, exist_ok=True)
