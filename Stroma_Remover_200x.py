    ...
    with torch.no_grad():
        for img_name in img_names:
            if img_name != 'Thumbs.db':
                ...
                cv2.imwrite(image, join(output_path, img_name))

            
if __name__ == "__main__":
    parser = ap.ArgumentParser()
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/youngjin/data/stomach_new/10/256_rf4/patch/real/test/M')                        # '/vast/AI_team/sukmin/datasets/Task505_Stroma_NDM_prep_200x_whole/imagesTs') 
    parser.add_argument('-o', dest='output_path', default= '/vast/AI_team/youngjin/data/stomach_new/10/256_rf4/patch/real/Epi_Only/test/M')                                                                                    # "/vast/AI_team/sukmin/Results_Stroma_Remover/SeeDP/Colon_patch_CacoX_200x_e40k/test/D") 
