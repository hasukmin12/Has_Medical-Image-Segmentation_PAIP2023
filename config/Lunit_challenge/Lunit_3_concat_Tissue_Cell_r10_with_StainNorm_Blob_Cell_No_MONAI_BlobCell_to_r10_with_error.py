...
save_name = 'Lunit_3_concat_StainNorm_DL_se_ResNext_b8_with_Tissue_Cell_No_MOANI_Aug_BlobCell_to_r10_with_error_Split'
...
config = {
    ...
    # s * 32*4 = 3455 * 300
    # s * 8 = 320 * 200
    "MAX_ITERATIONS": 10000*5, #     10000 (= 8batch, 250 epochs)           9600 (= 8batch, 240 epochs)          8000 (= 8batch, 200 epochs)             
