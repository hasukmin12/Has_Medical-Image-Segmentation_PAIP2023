...
save_name = 'Lunit_Cell_only_StainNorm_DL_se_ResNext_b8_JustCell_r10'

info = {
    "TARGET_NAME"   : "Lunit_Challenge",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task746_Lunit_Cell_StainNorm_rad10_JustCell",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 2,
