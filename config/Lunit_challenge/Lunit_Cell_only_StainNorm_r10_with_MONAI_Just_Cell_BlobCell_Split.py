...
save_name = 'Lunit_Cell_only_StainNorm_DL_se_ResNext_b8_JustCell_BlobCell_Split'

info = {
    "TARGET_NAME"   : "Lunit_Challenge",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task749_Lunit_Cell_StainNorm_BlobCell_JustCell_Split",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 2,
...
config = {
    ...
    # s * 32*4 = 3455 * 300
    # s * 8 = 320 * 200
    "MAX_ITERATIONS": 10000*2, #     10000 (= 8batch, 250 epochs)           9600 (= 8batch, 240 epochs)          8000 (= 8batch, 200 epochs)             
