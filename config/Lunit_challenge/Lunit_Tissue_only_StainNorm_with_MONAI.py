...
save_name = 'Lunit_Tissue_only_StainNorm_DL_se_ResNext_b8_2_to_1'

info = {
    "TARGET_NAME"   : "Lunit_Challenge_Tissue_only",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task731_Lunit_Tissue_StainNorm_2_to_1",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 3,
    "CLASS_NAMES"   : {1:'Others', 2:'Tumor Area'}, # 0: "white space"
    "NUM_CLASS"     : 2,  
