...
save_name = 'Lunit_Tissue_only_StainNorm_DL_se_ResNext_b8_Only1_v2'

info = {
    "TARGET_NAME"   : "Lunit_Challenge_Tissue_only",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task732_Lunit_Tissue_StainNorm_Only1",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 2,
    "CLASS_NAMES"   : {1:'Cancer Area'}, # 0: "white space"
    "NUM_CLASS"     : 1,  
