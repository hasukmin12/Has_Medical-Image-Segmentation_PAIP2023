...
save_name = 'Lunit_Cell_only_ChannelNorm_DL_ResNext_b8_JustCell_BlobCell_v2'

info = {
    "TARGET_NAME"   : "Lunit_Challenge",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task748_Lunit_Cell_ChannelNorm_BlobCell_JustCell",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 2,
