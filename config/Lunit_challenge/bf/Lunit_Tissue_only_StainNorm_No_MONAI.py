...
save_name = 'Lunit_Tissue_only_StainNorm_DL_se_ResNext_b8_Only1'

info = {
    "TARGET_NAME"   : "Lunit_Challenge_Tissue_only",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task730_Lunit_Tissue_StainNorm",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 2,
    "CLASS_NAMES"   : {1:'Tumor Area'}, # 0: "white space"
    "NUM_CLASS"     : 1,  
...
config = {
    ...
    # s * 32*4 = 3455 * 300
    # s * 8 = 320 * 200
    "MAX_ITERATIONS": 10001*2, #     10000 (= 8batch, 250 epochs)           9600 (= 8batch, 240 epochs)          8000 (= 8batch, 200 epochs)             
