...
save_name = 'Lunit_Tissue_only_DL_se_resnext101_norm_b12'

info = {
    "TARGET_NAME"   : "Lunit_Challenge_Tissue_only",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Task710_Lunit_Tissue_only_Norm",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 3,
...
config = {
    ...
    # s * 32*4 = 3455 * 300
    # s * 12 = 320 * 270
    "MAX_ITERATIONS": 7200, #     7200 (= 12batch, 270 epochs)           9600 (= 8batch, 240 epochs)          8000 (= 8batch, 200 epochs)             
