...
save_name = 'Lunit_Tissue_only_CacoX_not_norm_b8'

info = {
    "TARGET_NAME"   : "Lunit_Challenge_Tissue_only",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Task711_Lunit_Tissue_only_Not_norm",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 3,
    "CLASS_NAMES"   : {1:'Tumor Area', 2:'Others'}, # 0: "white space"
    "NUM_CLASS"     : 2,  

    #### wandb
    "ENTITY"        : "hasukmin12",
    "PROJ_NAME"     : "Lunit_Challenge_Tissue",
...
config = {
    ...
    # s * 32*4 = 3455 * 300
    # s * 12 = 320 * 270
    "MAX_ITERATIONS": 10000, #     7200 (= 12batch, 270 epochs)           9600 (= 8batch, 240 epochs)          8000 (= 8batch, 200 epochs)             
    "EVAL_NUM"      : 400, # 20 epoch
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
    "MODEL_NAME"    : 'CacoX', # CacoX Lunit_UNet, 'DL_se_resnext101', 'DL_regnetx_320' , 'DL_ConvNext_large', # 'DL_se_resnet152', # 'DL_resnext101', # 'DL_dpn131', # "DL_se_resnext101", # DL_regnetx_320  # "MEDIAR_pretrain",  # unet_resnet101_pretrain # 'DeepLabV3Plus_resnet101_pretrain', # "CA_Swin_deep_dense",
    "OPTIM_NAME"    : "AdamW",
