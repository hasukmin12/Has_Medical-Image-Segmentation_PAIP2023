...
save_name = 'Lunit_Baseline_UNet'

info = {
    "TARGET_NAME"   : "Lunit_Challenge",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task703_Lunit_Cell_only_not_norm_rad12",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 3,
...
config = {
    ...
    # s * 32*4 = 3455 * 300
    # s * 8 = 320 * 200
    "MAX_ITERATIONS": 10000, #     10000 (= 8batch, 250 epochs)           9600 (= 8batch, 240 epochs)          8000 (= 8batch, 200 epochs)             
    "EVAL_NUM"      : 500, # 20 epoch
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
    "MODEL_NAME"    : 'Lunit_UNet', # CacoX Lunit_UNet, 'DL_se_resnext101', 'DL_regnetx_320' , 'DL_ConvNext_large', # 'DL_se_resnet152', # 'DL_resnext101', # 'DL_dpn131', # "DL_se_resnext101", # DL_regnetx_320  # "MEDIAR_pretrain",  # unet_resnet101_pretrain # 'DeepLabV3Plus_resnet101_pretrain', # "CA_Swin_deep_dense",
    "OPTIM_NAME"    : "AdamW",
