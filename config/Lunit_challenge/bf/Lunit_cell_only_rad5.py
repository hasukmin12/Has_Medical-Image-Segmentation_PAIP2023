...
save_name = 'Lunit_Cell_only_ResNet101_rad5'

info = {
    "TARGET_NAME"   : "Lunit_Challenge",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Task702_Lunit_Cell_only_rad5",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 3,
...
config = {
    ...
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
    "MODEL_NAME"    : 'unet_resnet101_pretrain', # 'DL_ConvNext_large', # 'DL_se_resnet152', # 'DL_resnext101', # 'DL_dpn131', # "DL_se_resnext101", # DL_regnetx_320  # "MEDIAR_pretrain",  # unet_resnet101_pretrain # 'DeepLabV3Plus_resnet101_pretrain', # "CA_Swin_deep_dense",
    "OPTIM_NAME"    : "AdamW",
