...
save_name = 'ST_CASwin_DiceFocal_deep_dice_easy_hard'

info = {
    "TARGET_NAME"   : "Neurips_Cellseg_semi",
    "VERSION"       : 1,
    "FOLD"          : 4,
    "FOLDS"         : 10, 
    ...
    "Teacher_pretrained_path" : "/vast/AI_team/sukmin/Results_monai_Neurips_Cellseg/CASwin_DiceFocal_deep/model_best.pth",
