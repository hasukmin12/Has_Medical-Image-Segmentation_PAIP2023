...
save_name = 'CAD_DL_ConvNext_large_long_b16_focal' # 'DL_eff-b8_b4' # 'DL_resnext101_b16' # 'DL_se_resnext101_b16' # 'MEDIAR_pretrain_b8'  # DL_regnety_320_b16  # DeepLabV3Plus_resnet101_pretrain_b32 # unet_resnet101_pretrain_b32_e4k
...
config = {
    ...
    "FAST"          : False,
    "MAX_ITERATIONS": 8400,             # 2520, # (= 4batch, 240 epochs)          # 2940, # (= 4batch, 280 epochs)          # 3150 (= 4batch, 300 epochs)            # 4200 (= 4batch, 400 epochs)            8400 (= 4batch, 800 epochs)                    # 10500, # (= 1750 epochs) # 7875, # 4200*4, # 5250, # 4200, # 10000, # 14500, # 20000, # 논문처럼 하려면 800 epoch = 14400 step으로 해야함 -> s*4(b) = 72(n)*800(e) # 여기 참고 : http://esignal.co.kr/ai-ml-dl/?board_name=ai_ml_dl&search_field=fn_title&order_by=fn_pid&order_type=asc&board_page=1&list_type=list&vid=15
    # "MAX_EPOCHS" : 400,
    "EVAL_NUM"      : 105, # 10, # 105, # (= 4batch, 10 epochs)  # 60, # 6, # 500, #500, 
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
    "MODEL_NAME"    : 'ConvNext_large', # 'DL_se_resnet152', # 'DL_resnext101', # 'DL_dpn131', # "DL_se_resnext101", # DL_regnetx_320  # "MEDIAR_pretrain",  # unet_resnet101_pretrain # 'DeepLabV3Plus_resnet101_pretrain', # "CA_Swin_deep_dense",
    "OPTIM_NAME"    : "AdamW",
    "LR_INIT"       : 2e-05, # 5e-04,
    "LR_DECAY"      : 1e-05,
    "MOMENTUM"      : 0.9,
