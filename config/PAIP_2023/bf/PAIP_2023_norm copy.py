...
save_name = 'DL_ConvNext_large_b16' # 'DL_eff-b8_b4' # 'DL_resnext101_b16' # 'DL_se_resnext101_b16' # 'MEDIAR_pretrain_b8'  # DL_regnety_320_b16  # DeepLabV3Plus_resnet101_pretrain_b32 # unet_resnet101_pretrain_b32_e4k
...
config = {
    ...
    "FAST"          : False,
    "MAX_ITERATIONS": 2520, # (= 4batch, 240 epochs)          # 2940, # (= 4batch, 280 epochs)        # 4200 (= 4batch, 400 epochs)         # 3150 (= 4batch, 300 epochs          # 10500, # (= 1750 epochs) # 7875, # 4200*4, # 5250, # 4200, # 10000, # 14500, # 20000, # 논문처럼 하려면 800 epoch = 14400 step으로 해야함 -> s*4(b) = 72(n)*800(e) # 여기 참고 : http://esignal.co.kr/ai-ml-dl/?board_name=ai_ml_dl&search_field=fn_title&order_by=fn_pid&order_type=asc&board_page=1&list_type=list&vid=15
    # "MAX_EPOCHS" : 400,
