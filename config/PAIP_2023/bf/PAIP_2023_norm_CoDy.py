...
save_name = 'CAD_DL_ConvNext_large_b16' # 'DL_eff-b8_b4' # 'DL_resnext101_b16' # 'DL_se_resnext101_b16' # 'MEDIAR_pretrain_b8'  # DL_regnety_320_b16  # DeepLabV3Plus_resnet101_pretrain_b32 # unet_resnet101_pretrain_b32_e4k
...
config = {
    ...
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
    "MODEL_NAME"    : 'CAD_ConvNext_large', # 'DL_resnext101', # 'DL_dpn131', # "DL_se_resnext101", # DL_regnetx_320  # "MEDIAR_pretrain",  # unet_resnet101_pretrain # 'DeepLabV3Plus_resnet101_pretrain', # "CA_Swin_deep_dense",
    "OPTIM_NAME"    : "AdamW",
    "LR_INIT"       : 5e-04,
    "LR_DECAY"      : 1e-05,
    "MOMENTUM"      : 0.9,
