...
save_name = 'CacoX_50x_only_SE_overlap25_r256'

info = {
    "TARGET_NAME"   : "Stroma_NDM",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Task611_Stroma_Only_Epi_50x_overlap25_r256",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 4,
...
info["WORKERS"] = 16*2 # 4*info["NUM_GPUS"] if info["MEM_CACHE"]>0 else 8*info["NUM_GPUS"]
...
config = {
    ...
    # s * 32*4 = 3455 * 300
    # s * 128 = 
    "MAX_ITERATIONS": 8098, # (= 128batch, 300 epochs)             # 75555, # (= 32batch, 240 epochs)          # 88147, # (= 32batch, 280 epochs) 
    "EVAL_NUM"      : 405, # 20 epoch
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
