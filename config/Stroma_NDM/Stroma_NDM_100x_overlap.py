...
save_name = 'CacoX_b32_100x_overlap75'

info = {
    "TARGET_NAME"   : "Stroma_NDM",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Task514_Stroma_NDM_prep_100x_no_overlap",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 7,
...
config = {
    ...
    # s * b = n * e
    # s * 32 = 2729 * 200
    "MAX_ITERATIONS": 17056, # (=32batch, 200 epoch)             
    "EVAL_NUM"      : 1705, # 20 epoch
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
