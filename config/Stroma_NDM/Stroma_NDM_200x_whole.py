...
save_name = 'CacoX_b32_200x_whole'

info = {
    "TARGET_NAME"   : "Stroma_NDM",
    "VERSION"       : 1,
    "FOLD_for_CrossValidation" : False, # False # 5
    "ROOT"          : "/vast/AI_team/sukmin/datasets/Task410_Stroma_NDM_prep_200x_whole",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 7,
...
config = {
    ...
    # s * b = n * e
    # s * 32 = 10074 * 280
    "MAX_ITERATIONS": 88147,             # 75555, # (= 32batch, 240 epochs)          # 88147, # (= 32batch, 280 epochs) 
    "EVAL_NUM"      : 500, # 105, # 10, # 105, # (= 4batch, 10 epochs)  # 60, # 6, # 500, #500, 
    "SAMPLES"       : 2,
    "SEEDS"         : 12321,
