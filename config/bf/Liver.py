...
info = {
    ...
    "ROOT"          : "/home/sukmin/datasets/Task106_Liver",
    "CHANNEL_IN"    : 3,
    "CHANNEL_OUT"   : 5,
    "CLASS_NAMES"   : {1:'part 7', 2:'part 8', 3:'part 5', 4: 'part 6'},
    "NUM_CLASS"     : 4,  
...
info["LOGDIR"] = os.path.join(f'/vast/AI_team/sukmin/past_results/Results_monai_{info["TARGET_NAME"]}', save_name)
