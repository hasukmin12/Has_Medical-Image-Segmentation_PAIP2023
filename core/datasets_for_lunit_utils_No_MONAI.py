...
class Dataset_Lunit_Single(Dataset):
    def __init__(self, config, image_paths, target_paths, transform=None, train=True):   # initial logic happens like transform
...
class Dataset_Lunit(Dataset):
    def __init__(self, config, image_paths, target_paths, t_path, c_path, transform=None, train=True):   # initial logic happens like transform
