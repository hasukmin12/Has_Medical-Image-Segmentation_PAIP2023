...
from core.model.Conv_blocks_light import CoordAtt, DDenseDownLayer_2, DDenseDownBlock_2, DenseUpBlock, DenseUpLayer , DDenseDownLayer_first, DDenseDownBlock_first
...
class CADD_UNet_light(nn.Module):
