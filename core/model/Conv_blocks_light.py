...
class DDenseDownBlock_2(nn.Module):
    def __init__(self, in_planes, out_planes, kernel_size, dropout_rate):
        ...
        self.conv_1 = DDense_Block(in_planes, in_planes, kernel_size=kernel_size, dropout_rate=dropout_rate)
        self.conv_2 = DDense_Block(in_planes*2, in_planes, kernel_size=kernel_size, dropout_rate=dropout_rate)
        ...
        # conv3 = 1*1 conv
        self.conv_1_1 = nn.Conv2d(in_planes * 3, in_planes * 2, [1 for _ in kernel_size], padding=[0 for i in kernel_size])
        self.norm_1_1 = nn.BatchNorm2d(in_planes * 2, eps=1e-05, momentum=0.1, affine=True, track_running_stats=False)
        self.nonlin_1_1 = nn.LeakyReLU(negative_slope=0.01, inplace=True)
    ...
    def forward(self, x):
        ...
        residual_out = self.nonlin_1_1(self.norm_1_1(self.conv_1_1(residual_2)))  # 32
        out = self.pool_op(residual_out)
