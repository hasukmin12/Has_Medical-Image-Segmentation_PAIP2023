...
from core.model.MEDIAR_MAnet import MAnet
...
class MEDIARFormer(MAnet):
    ...
    def __init__(
        ...
        self.cellprob_head = DeepSegmantationHead(
            in_channels=decoder_channels[-1], out_channels=classes, kernel_size=3,
        )
        # self.gradflow_head = DeepSegmantationHead(
        #     in_channels=decoder_channels[-1], out_channels=(classes/2),  kernel_size=3,   # out_channels=2, kernel_size=3,
        # )
