...
path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Lunit_Tissue_cutting/labelsTs"
path_list = sorted(next(os.walk(path))[2])

aim_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Lunit_Tissue_cutting_200_100/labelsTs"
