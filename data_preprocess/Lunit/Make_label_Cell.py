...
img_path = '/vast/AI_team/sukmin/datasets/Lunit_Norm/images/train/cell'
...
for case in anno_list:
    ...
    cv2.imwrite(seg.astype(np.uint8), join(aim_path, '{0:03d}.jpg'.format(anno_list.index(case)+1)))
