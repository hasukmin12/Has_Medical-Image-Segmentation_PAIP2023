...
label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task723_Lunit_Cell_StainNorm_rad10/labelsTs"
...
aim_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task723_Lunit_Cell_StainNorm_rad10/labelsTs_blob"
os.makedirs(aim_path, exist_ok=True)

vis_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task723_Lunit_Cell_StainNorm_rad10/labelsTs_blob_vis"
os.makedirs(vis_path, exist_ok=True)

vis_path2 = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task723_Lunit_Cell_StainNorm_rad10/labelsTs_blob_vis2"
...
for case in img_list:
    ...
    anno = open(join(coord_path, coord_list[img_list.index(case)]), 'r', encoding='utf-8')
    pt = csv.reader(anno)
    ...
    for line in pt:
        ...
        if not_in_contour==False:
            if cls == 1:
                cv2.circle(seg, (x,y), 10, 1, -1)
            elif cls == 2:
                cv2.circle(seg, (x,y), 10, 2, -1)
