...
img_path = '/vast/AI_team/sukmin/datasets/ocelot2023_v0.1.1/images/train/cell'
img_list = sorted(next(os.walk(img_path))[2])

aim_dir = '/vast/AI_team/sukmin/datasets/Lunit_Norm/images/train/cell'
...
for case in img_list:
    if case[-4:]==".jpg":
        ...
        # cv2.imwrite(test_npy01, join(aim_dir, case))
