...
train_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/imagesTr"
train_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/labelsTr"
train_tissue_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/Lunit_Tissue_cutting_Upscaling_255/labelsTr"
train_cell_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/JustCell_BlobCell_labels_255/labelsTr"

aim_train_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task753_Lunit_Cell_StainNorm_Blob_Cell_to_r10_Aug/imagesTr"
aim_train_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task753_Lunit_Cell_StainNorm_Blob_Cell_to_r10_Aug/labelsTr"
aim_train_tissue_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task753_Lunit_Cell_StainNorm_Blob_Cell_to_r10_Aug/Lunit_Tissue_cutting_Upscaling_255/labelsTr"
aim_train_cell_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task753_Lunit_Cell_StainNorm_Blob_Cell_to_r10_Aug/JustCell_BlobCell_labels_255/labelsTr"
...
# for error label
error_tissue_path = '/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/error_cell_prediction/labelsTr'
# error_cell_path = '/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/error_cell_prediction/labelsTr'
...
for case in img_list:
    if case[-4:]==".png":
        ...
        # shift scale rotate
        # scale 0.5
        aug_scale_5 = at.ShiftScaleRotate(shift_limit=0, scale_limit=(0.5,0.5), rotate_limit=0, p=1)
