...
if __name__ == "__main__":
    ...
    base = "/vast/AI_team/sukmin/datasets"

    task_id = 703
    task_name = "Lunit_Cell_only_not_norm_rad17"
    ...
    val_patient_names = []
    test_patient_names = []
    img_path = join(base, 'Lunit_Not_norm', 'images', 'train', 'cell')
    seg_path = join(base, 'Lunit_Not_norm', 'annotations', 'train', 'cell_seg_17')
