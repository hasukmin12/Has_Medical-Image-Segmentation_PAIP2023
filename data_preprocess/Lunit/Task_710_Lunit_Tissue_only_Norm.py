...
if __name__ == "__main__":
    ...
    task_id = 710
    task_name = "Lunit_Tissue_only_Norm"
    ...
    val_patient_names = []
    test_patient_names = []
    img_path = join(base, 'images', 'train', 'tissue_start_0')
    seg_path = join("/vast/AI_team/sukmin/datasets/Lunit_Not_norm", 'annotations', 'train', 'tissue_for_train_012')
