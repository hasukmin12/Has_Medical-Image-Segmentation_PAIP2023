...
if __name__ == "__main__":
    ...
    task_id = 736
    task_name = "Lunit_Tissue_ChannelNorm_Only1"
    ...
    val_patient_names = []
    test_patient_names = []
    img_path = join(base, '/vast/AI_team/sukmin/datasets/Lunit_Challenge/Lunit_Norm/images/train/tissue_start_0')
    seg_path = join(base, 'annotations', 'train', 'Tissue_for_train_Only1')
