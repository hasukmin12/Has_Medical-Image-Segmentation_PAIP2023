...
if __name__ == "__main__":
    ...
    task_id = 748
    task_name = "Lunit_Cell_ChannelNorm_BlobCell_JustCell"
    ...
    val_patient_names = []
    test_patient_names = []
    img_path = join('/vast/AI_team/sukmin/datasets/Lunit_Challenge/Lunit_Norm/images/train/cell_start_0_case')
