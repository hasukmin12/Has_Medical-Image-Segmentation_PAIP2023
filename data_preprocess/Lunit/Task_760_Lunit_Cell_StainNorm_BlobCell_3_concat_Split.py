...
if __name__ == "__main__":
    ...
    base = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task760_3_concat_Datasets"

    task_id = 761
    task_name = "Lunit_Cell_StainNorm_BlobCell_3_concat_Split"
    ...
    val_patient_names = []
    test_patient_names = []
    img_path = join(base, 'images')
    seg_path = join(base, 'labels')
    ...
    labelstr = join(out_base, "Lunit_Tissue_cutting_Upscaling_255", "labelsTr")
    labelsts = join(out_base, "Lunit_Tissue_cutting_Upscaling_255", "labelsTs")

    os.makedirs(labelstr, exist_ok=True)
    os.makedirs(labelsts, exist_ok=True)

    seg_path = join(base, "Lunit_Tissue_cutting_Upscaling_255", 'labels')
    ...
    labelstr = join(out_base, "JustCell_BlobCell_labels_255", "labelsTr")
    labelsts = join(out_base, "JustCell_BlobCell_labels_255", "labelsTs")

    os.makedirs(labelstr, exist_ok=True)
    os.makedirs(labelsts, exist_ok=True)

    seg_path = join(base, "JustCell_BlobCell_labels_255", 'labels')
