...
if __name__=='__main__':
    ...
    parser.add_argument('--imageDir', type=str, default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Lunit_Not_norm/images/train/tissue', help='RGB image file')
    parser.add_argument('--saveDir', type=str, default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Lunit_Not_norm/images/train/tissue_Stain', help='save file')
