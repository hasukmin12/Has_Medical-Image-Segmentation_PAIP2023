...
path = "/vast/AI_team/sukmin/datasets/Task508_Stroma_NDM_prep_50x_whole/imagesTs"
path_list = sorted(next(os.walk(path))[2])

# test_images = sorted(glob.glob(os.path.join(input_path, "*.png")))

gt_dir = "/vast/AI_team/sukmin/datasets/Task508_Stroma_NDM_prep_50x_whole/labelsTs"
aim_overlay_dir = '/vast/AI_team/sukmin/datasets/Task602_Stroma_Only_Epi_50x_whole_image/overlay_gt'
os.makedirs(aim_overlay_dir, exist_ok=True)

aim_labelsTs_dir = '/vast/AI_team/sukmin/datasets/Task602_Stroma_Only_Epi_50x_whole_image/labelsTs'
...
gt_dir = "/vast/AI_team/sukmin/datasets/Task508_Stroma_NDM_prep_50x_whole/labelsTr"
# path = path_tr
path_list = sorted(next(os.walk(gt_dir))[2])

aim_labelsTr_dir = '/vast/AI_team/sukmin/datasets/Task602_Stroma_Only_Epi_50x_whole_image/labelsTr'
