...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='/home/sukmin/datasets/Turing_test_set', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='/home/sukmin/datasets/Turing_test_set_prep', type=str, help='preprocessing data path')    
