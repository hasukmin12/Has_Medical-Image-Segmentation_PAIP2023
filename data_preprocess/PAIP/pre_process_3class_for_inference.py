...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='/home/sukmin/datasets/turing_test', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='/home/sukmin/datasets/turing_test_prep', type=str, help='preprocessing data path')    
