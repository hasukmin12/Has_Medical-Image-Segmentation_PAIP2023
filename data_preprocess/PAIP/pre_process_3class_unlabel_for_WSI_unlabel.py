...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='/home/sukmin/datasets/WSI_unlabeled', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='/home/sukmin/datasets/Task021_NeurIPS_Cellseg_unlabeled_patches', type=str, help='preprocessing data path')    
    ...
    for img_name in zip(tqdm(img_names[3:])):
