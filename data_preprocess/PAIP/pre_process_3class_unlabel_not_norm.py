...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='/vast/AI_team/sukmin/datasets/Task011_NeurIPS_Cellseg_unlabeled_tif/imagesTr', type=str, help='training data path; subfolders: images, labels')
    ...
    for img_name in tqdm(img_names[125:]):
        ...
        io.imsave(join(target_path, 'imagesTr', img_name.split('.')[0]+'.png'), pre_img_data.astype(np.uint8), check_contrast=False)
