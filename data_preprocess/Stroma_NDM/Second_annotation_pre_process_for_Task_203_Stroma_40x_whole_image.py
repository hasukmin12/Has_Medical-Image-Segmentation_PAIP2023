...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='/vast/AI_team/sukmin/datasets/2차annotation/40x(Downsample5)', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='/vast/AI_team/sukmin/datasets/Task_Stroma_prep_40x_whole', type=str, help='preprocessing data path')    
