...
def main():
    ...
    parser.add_argument("-o", '--output_path', default='/vast/AI_team/sukmin/datasets/Task_Stroma_prep_50x_only_SE_overlap25_r256', type=str, help='preprocessing data path')    
            ...
            for case in case_list:
                if case != 'Thumbs.db':
                    ...
                    if case[-9:] != 'label.png':
                        ...
                        patch_size = 256
                        patch_term = 192           # 435 # 85%            # 384 - 75%          # 256 - 50%            # 128  - 25%
