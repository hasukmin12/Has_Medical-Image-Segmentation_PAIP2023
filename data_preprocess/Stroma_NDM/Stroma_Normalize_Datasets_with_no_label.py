...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='/vast/AI_team/sukmin/Datasets_for_inference/2022_stomach_400x', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='/vast/AI_team/sukmin/datasets/400x_Stroma_prep', type=str, help='preprocessing data path')    
    ...
    for img_name in tqdm(img_names):
        ...
        io.imsave(join(target_path, 'images', img_name), pre_img_data.astype(np.uint8), check_contrast=False)
        # io.imsave(join(target_path, 'labels', gt_name), interior_map.astype(np.uint8), check_contrast=False)
