...
if __name__ == "__main__":
    ...
    task_id = 1
    task_name = "Test_Norm_Cellseg_Not_norm"
    ...
    val_patient_names = []
    test_patient_names = []
    train_img_path = join(base, 'Training', 'Training_prep_Not_norm', 'images')
    train_seg_path = join(base, 'Training', 'Training_prep_Not_norm', 'labels')
    ...
    val_img_path = join(base, 'Tuning', 'Tuning_prep_Not_norm', 'images')
    val_seg_path = join(base, 'Tuning', 'Tuning_prep_Not_norm', 'labels')
