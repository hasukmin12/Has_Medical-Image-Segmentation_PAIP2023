...
if __name__ == "__main__":
    ...
    task_id = 2
    task_name = "Test_Norm_Cellseg_ChannelNorm"
    ...
    val_patient_names = []
    test_patient_names = []
    train_img_path = join(base, 'Training', 'Training_prep_ChannelNorm', 'images')
    train_seg_path = join(base, 'Training', 'Training_prep_ChannelNorm', 'labels')
    ...
    val_img_path = join(base, 'Tuning', 'Tuning_prep_ChannelNorm', 'images')
    val_seg_path = join(base, 'Tuning', 'Tuning_prep_ChannelNorm', 'labels')
