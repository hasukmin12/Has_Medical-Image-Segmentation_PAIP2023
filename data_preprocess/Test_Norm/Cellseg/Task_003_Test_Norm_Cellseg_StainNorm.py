...
if __name__ == "__main__":
    ...
    task_id = 3
    task_name = "Test_Norm_Cellseg_StainNorm"
    ...
    val_patient_names = []
    test_patient_names = []
    train_img_path = join(base, 'Training', 'Training_prep_StainNorm', 'images')
    train_seg_path = join(base, 'Training', 'Training_prep_StainNorm', 'labels')
    ...
    val_img_path = join(base, 'Tuning', 'Tuning_prep_StainNorm', 'images')
    val_seg_path = join(base, 'Tuning', 'Tuning_prep_StainNorm', 'labels')
