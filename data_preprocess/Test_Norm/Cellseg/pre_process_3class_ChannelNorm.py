...
def main():
    ...
    parser.add_argument('-i', '--input_path', default='/vast/AI_team/sukmin/datasets/Test_Norm/Cellseg/Test', type=str, help='training data path; subfolders: images, labels')
    parser.add_argument("-o", '--output_path', default='/vast/AI_team/sukmin/datasets/Test_Norm/Cellseg/Test/Test_prep_Channel_norm', type=str, help='preprocessing data path')    
