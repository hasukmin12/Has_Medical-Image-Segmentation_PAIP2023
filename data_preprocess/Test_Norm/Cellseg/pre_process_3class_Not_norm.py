...
def main():
    ...
    parser.add_argument("-o", '--output_path', default='/vast/AI_team/sukmin/datasets/Test_Norm/Cellseg/Test/Test_prep_Not_norm', type=str, help='preprocessing data path')    
