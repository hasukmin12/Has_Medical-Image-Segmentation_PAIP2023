...
def main():
    ...
    parser.add_argument("-o", '--output_path', default='/vast/AI_team/sukmin/datasets/Test_Norm/Cellseg/Training/Training_prep_StainNorm', type=str, help='preprocessing data path')    
