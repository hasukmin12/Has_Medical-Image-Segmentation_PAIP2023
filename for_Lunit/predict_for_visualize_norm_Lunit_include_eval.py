...
def main(info, config, args):
    ...
    # 비교하려는 GT 폴더 결과
    folder_with_gt = '/vast/AI_team/sukmin/datasets/Task703_Lunit_Cell_only_not_norm_rad12/labelsTs/'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_cell_only_UNet_baseline') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_Only_cell_UNet_Baseline_r12") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='ocelot_unet.pth') # model_e15000.pth # model_best_6296.pth
