...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_Cell_Only_StainNorm_rad10_Blob_Cell') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_Only_cell_StainNorm_Blob_Cell_DL_se_ResNext_b8_r10_e8.5k") # Test_200x_CacoX_b32_e45k  
