    ...
    with torch.no_grad():
        for img_name in img_names:
            if img_name != 'Thumbs.db':
                ...
                # test_tensor = test_tensor / test_tensor.max()
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_Cell_Only_StainNorm_DL_se_ResNext_b8_rad10_Blob_Cell_No_ScaleIntensityd_div255') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_Only_cell_StainNorm_Blob_Cell_DL_se_ResNext_No_ScaleIntensityd_div255_b8_r10_e8.5k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_e08500.pth') # model_e04500.pth # model_best_e09000.pth # class_model_best_e06800.pth
