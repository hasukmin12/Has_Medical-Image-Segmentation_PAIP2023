...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', dest='epoch_num', default='model_best_e05700_dice0.7045586866338163.pth') # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
