...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_JustCell_StainNorm_DL_ResNext_b8_BlobCell_Split_e5.7k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_best_e07600_dice0.7121158149927108.pth') # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
    parser.add_argument('-f_gt', dest='folder_to_inference', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task749_Lunit_Cell_StainNorm_BlobCell_JustCell_Split/labelsTs')
