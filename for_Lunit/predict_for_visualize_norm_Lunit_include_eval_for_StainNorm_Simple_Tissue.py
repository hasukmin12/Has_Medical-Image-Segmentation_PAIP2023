...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_Tissue_only_StainNorm_with_MONAI_Only1') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task711_Lunit_Tissue_only_Not_norm/imagesTs') # Task701_Lunit_Cell_only/For_inference/imagesTs  
    parser.add_argument('-o', dest='aim_path', default="Lunit_Tissue_StainNorm_DL_se_ResNext_b8_Only1_v2_e4.4k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_best_e04400_dice0.7684633323512482.pth') # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
    parser.add_argument('-f_gt', dest='folder_to_inference', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task732_Lunit_Tissue_StainNorm_Only1/labelsTs')
    ...
    args.output_path = join('/vast/AI_team/sukmin/Results_Lunit_Tissue', args.aim_path)
    args.output_path_for_visualize = join('/vast/AI_team/sukmin/Results_visualize_Lunit_Tissue', args.aim_path)
