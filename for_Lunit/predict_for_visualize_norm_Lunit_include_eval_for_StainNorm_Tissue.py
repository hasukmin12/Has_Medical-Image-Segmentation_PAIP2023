                    ...
                    for x in range(rst.shape[0]):
                        for y in range(rst.shape[1]):
                            if rst[x][y][0] == 0:
                                ...
                                rst[x][y] = [69, 48, 237]   # BGR  - Cancer Area (Red)
                            elif rst[x][y][0] == 2:
                                rst[x][y] = [149, 184, 135]  # Others (Green)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_Tissue_only_StainNorm') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task711_Lunit_Tissue_only_Not_norm/imagesTs') # 2022_stomach_200x - Testset  
    parser.add_argument('-o', dest='aim_path', default="Lunit_Tissue_StainNorm_DL_ConvNext_b8_e15k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_e15000.pth') # model_e15000.pth # model_best_6296.pth
    parser.add_argument('-f_gt', dest='folder_to_inference', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task730_Lunit_Tissue_StainNorm/labelsTs')
