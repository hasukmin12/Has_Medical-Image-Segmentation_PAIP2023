    ...
    with torch.no_grad():
        for img_name in img_names:
            if img_name != 'Thumbs.db':
                ...
                test_pred_out = model(test_tensor, tissue_pred_out)
                ...
                if args.show_overlay:
                    ...
                    cv2.imwrite(join(args.output_path_for_visualize, 'seg_' + img_name), rst)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_tissue_with_StainNorm_rad10') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_Tissue_with_StainNorm_DL_se_ResNext_b8_r10_DS_e3k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_e03000.pth') # model_e15000.pth # model_best_6296.pth
    ...
    parser.add_argument('-i_t', dest='tissue_input_path', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Lunit_Tissue_cutting/imagesTs')
