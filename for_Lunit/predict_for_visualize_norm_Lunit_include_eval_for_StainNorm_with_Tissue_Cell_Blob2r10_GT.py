...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Lunit_3_concat_Tissue_Cell_r10_with_StainNorm_Blob_Cell_No_MONAI_BlobCell_to_r10') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_3_concat_Tissue_Cell_r10_with_StainNorm_Blob_Cell_No_MONAI_BlobCell_to_r10_Aug_cb17k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='class_model_best_e17000_dice0.5061750411987305.pth') # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
    ...
    parser.add_argument('-i_t', dest='tissue_input_path', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/Lunit_Tissue_cutting_Upscaling_255/labelsTs')
    ...
    parser.add_argument('-i_c', dest='cell_input_path', default='/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/JustCell_BlobCell_labels_255/labelsTs')
