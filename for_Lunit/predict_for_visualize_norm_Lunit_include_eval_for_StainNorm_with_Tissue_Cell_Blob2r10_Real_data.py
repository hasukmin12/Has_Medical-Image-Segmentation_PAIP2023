    ...
    with torch.no_grad():
        for img_name in img_names:
            if img_name != 'Thumbs.db':
                ...
                check_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task750_Lunit_Cell_StainNorm_Blob_Cell_to_r10/Test_in_training_crop/test2"
                os.makedirs(check_path, exist_ok=True)
                Image.fromarray(vis_tis_seg*255).save(join(check_path, "tissue_" + img_name))
                ...
                # save for check
                Image.fromarray(vis_cell*255).save(join(check_path, "cell_" + img_name))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_3_concat_Tissue_Cell_r10_with_StainNorm_Blob_Cell_No_MONAI_BlobCell_to_r10_Aug_Focal_error_Real_data_e12k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_e12000.pth')  # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
    ...
    parser.add_argument('-m_c', dest='cell_model_path', default='/vast/AI_team/sukmin/Results_monai_Lunit_Challenge/Lunit_Cell_only_StainNorm_DL_se_ResNext_b8_JustCell_BlobCell/model_best_e05200_dice0.7388840360945143.pth')
