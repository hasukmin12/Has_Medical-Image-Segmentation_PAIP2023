    ...
    with torch.no_grad():
        for img_name in img_names:
            if img_name != 'Thumbs.db':
                ...
                # save for check
                Image.fromarray(vis_cell*200).save(join(check_path, "cell_" + img_name))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', dest='aim_path', default="Lunit_3_concat_Tissue_Cell_r10_StainNorm_Blob_Cell_DL_se_ResNext_b8_No_MONAI_Aug_Real_data_b13.5k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_best_e13500.pth') # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
    ...
    parser.add_argument('-m_c', dest='cell_model_path', default='/vast/AI_team/sukmin/Results_monai_Lunit_Challenge/Lunit_Cell_only_StainNorm_DL_se_ResNext_b8_JustCell_r10/model_best_e01600_dice0.5981134025175291.pth')
