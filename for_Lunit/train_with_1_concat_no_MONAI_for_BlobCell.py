...
from core.core_for_lunit_1_concat_No_MONAI import train
...
from core.datasets_for_No_MONAI import call_dataloader_Lunit, call_dataloader_Lunit_single
join = os.path.join
...
def main(info, config, logging=False):
    ...
    train_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task749_Lunit_Cell_ChannelNorm_BlobCell_JustCell_Aug/imagesTr"
    train_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task749_Lunit_Cell_ChannelNorm_BlobCell_JustCell_Aug/labelsTr"
    # train_tissue_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task740_Lunit_Cell_StainNorm_r10_Blob_Cell/Lunit_Tissue_cutting_Upscaling_255/labelsTr"
    # train_cell_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task740_Lunit_Cell_StainNorm_r10_Blob_Cell/labelsTr_circle_150"

    val_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task749_Lunit_Cell_ChannelNorm_BlobCell_JustCell_Aug/imagesTs"
    val_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task749_Lunit_Cell_ChannelNorm_BlobCell_JustCell_Aug/labelsTs"
    ...
    # val_cell_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task740_Lunit_Cell_StainNorm_r10_Blob_Cell/labelsTs_circle_150"
    ...
    if info["FOLD_for_CrossValidation"] == False:
        train_loader = call_dataloader_Lunit_single(info, config, train_img_path, train_label_path,  transforms=None, mode="train")
        valid_loader = call_dataloader_Lunit_single(info, config, val_img_path, val_label_path, transforms=None, mode="valid")
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trainer', default= 'Lunit_Cell_only_ChannelNorm_r10_No_MONAI_Just_Cell_BlobCell') # Stroma_200x_only_Epi
