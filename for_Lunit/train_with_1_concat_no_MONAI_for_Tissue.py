...
def main(info, config, logging=False):
    ...
    train_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task747_Lunit_Cell_StainNorm_BlobCell_JustCell/imagesTr"
    train_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task747_Lunit_Cell_StainNorm_BlobCell_JustCell/labelsTr"
    ...
    val_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task747_Lunit_Cell_StainNorm_BlobCell_JustCell/imagesTs"
    val_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task747_Lunit_Cell_StainNorm_BlobCell_JustCell/labelsTs"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trainer', default= 'Lunit_Tissue_only_StainNorm_No_MONAI') # Stroma_200x_only_Epi
