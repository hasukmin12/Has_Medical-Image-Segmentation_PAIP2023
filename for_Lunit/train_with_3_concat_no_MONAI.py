...
def main(info, config, logging=False):
    ...
    train_img_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task762_Lunit_Cell_StainNorm_BlobCell_3_concat_Split_Aug/imagesTr"
    train_label_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task762_Lunit_Cell_StainNorm_BlobCell_3_concat_Split_Aug/labelsTr"
    train_tissue_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task762_Lunit_Cell_StainNorm_BlobCell_3_concat_Split_Aug/Lunit_Tissue_cutting_Upscaling_255/labelsTr"
    train_cell_path = "/vast/AI_team/sukmin/datasets/Lunit_Challenge/Task762_Lunit_Cell_StainNorm_BlobCell_3_concat_Split_Aug/JustCell_BlobCell_labels_255/labelsTr"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trainer', default= 'Lunit_3_concat_Tissue_Cell_r10_with_StainNorm_Blob_Cell_No_MONAI_BlobCell_to_r10_Split') # Stroma_200x_only_Epi
