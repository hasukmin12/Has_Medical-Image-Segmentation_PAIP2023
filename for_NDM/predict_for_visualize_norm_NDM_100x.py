...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Stroma_NDM_100x_io') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Task506_Stroma_NDM_prep_100x_whole/imagesTs') # 2022_stomach_200x - Testset  
    parser.add_argument('-o', dest='aim_path', default="io_Test_100x_CacoX_b32_b10230") # Test_ResUNet_b256_256_e06k  # 400x
    parser.add_argument('-n', dest='epoch_num', default='model_best_10230.pth') # model_e15000.pth # model_best_8525.pth
