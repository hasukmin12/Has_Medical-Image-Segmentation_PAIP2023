...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Stroma_200x_only_Epi_r1024') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Task505_Stroma_NDM_prep_200x_whole/imagesTs') # 2022_stomach_200x - Testset  
    parser.add_argument('-o', dest='aim_path', default="Test_r1024_200x_CacoX_b8_e52k") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_e52000.pth') # model_e15000.pth # model_best_6296.pth
