...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Stroma_50x_only_Epi_r256') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Task508_Stroma_NDM_prep_50x_whole/imagesTs') # 2022_stomach_200x - Testset  
    parser.add_argument('-o', dest='aim_path', default="Test_r256_50x_CacoX_b8_b810") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_best_810.pth') # model_e15000.pth # model_best_6296.pth
