...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Stroma_NDM_200x')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/TransferTest_NET/고영신') # 2022_stomach_200x - Testset  
    parser.add_argument('-o', dest='aim_path', default="TransferTest_NET_200x_CacoX_고영신") # Test_ResUNet_b256_256_e06k  # 400x
    parser.add_argument('-n', dest='epoch_num', default='model_e48000.pth') # model_e15000.pth # model_best_8525.pth
    ...
    args.output_path = join('/vast/AI_team/sukmin/Results_Stroma_NDM', args.aim_path)
    args.output_path_for_visualize = join('/vast/AI_team/sukmin/Results_visualize_Stroma_NDM', args.aim_path)
