...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='PAIP_2023_norm')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/PAIP2023_Test') # 2022_stomach_200x - Testset  
    parser.add_argument('-o', dest='aim_path', default="Test_CacoX_b8_DiceCE_e3.4k") # Test_ResUNet_b256_256_e06k  # 400x
    parser.add_argument('-n', dest='epoch_num', default='model_best_3450.pth') # model_e15000.pth # model_best.pth
