...
def main(info, config, args):
    ...
    with torch.no_grad():
        import csv
        f = open(join(args.output_path, 'output.csv'), 'w', encoding='utf-8', newline='')
        wr = csv.writer(f)
        wr.writerow(["ID", "TC"])
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', dest='aim_path', default="Val_ResUNet_pretrained_101_b32_e5k_bf_b") # Val_DeepLabV3+_res101_b32_e14.5k_b
    parser.add_argument('-n', dest='epoch_num', default='model_best.pth') # model_e15000.pth # model_best.pth
