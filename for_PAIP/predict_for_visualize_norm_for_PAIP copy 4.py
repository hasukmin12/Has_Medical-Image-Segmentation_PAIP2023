...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', dest='aim_path', default="Val_DL_eff-b8_b") # Val_DeepLabV3+_res101_b32_e14.5k_b
    parser.add_argument('-n', dest='epoch_num', default='model_best.pth') # model_e02000.pth # model_best.pth
