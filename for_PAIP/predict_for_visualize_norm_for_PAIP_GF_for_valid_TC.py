...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', dest='aim_path', default="Val_CAD_DL_ConvNext_large_b8_bbbaseline_DiceCE_GF_0.3_TC_0.3_r1024_223") # Val_DeepLabV3+_res101_b32_e14.5k_b
    parser.add_argument('-n', dest='epoch_num', default='model_best_500.pth') # model_e02000.pth # model_best_2500.pth 
