...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Neurips_Cellseg')
    parser.add_argument('-i', dest='input_path', default="/vast/AI_team/sukmin/past_results/datasets_bf/Turing_test_set/images")
    parser.add_argument('-o', dest='output_path', default="/vast/AI_team/sukmin/past_results/Results_for_challenge/CAswin_deep_dense_b4_test")
