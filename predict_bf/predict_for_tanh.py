...
def main(info, config, args):
    ...
    with torch.no_grad():
        for test_data in test_loader:
            ...
            sw_batch_size = 4
            t0 = time.time()
            test_pred_out = sliding_window_inference_for_tanh(
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Stroma_tanh')
    parser.add_argument('-i', dest='input_path', default="/vast/AI_team/sukmin/datasets/Task200_Stroma/imagesTs") # Task113_Carotid_side
    parser.add_argument('-o', dest='aim_path', default="Stroma_CASwin-dd-tanh_b8_b") # Liver_UNet_b16_b
