...
def main(info, config, args):
    ...
    case_list = sorted(next(os.walk(args.input_path))[1])

    for case in case_list:

        test_images = sorted(glob.glob(os.path.join(args.input_path, case, 't', "*.png")))
        ...
        with torch.no_grad():
            for test_data in test_loader:
                ...
                if args.show_overlay:
                    ...
                    image = cv2.imread(join(args.input_path, case, 't', img_name))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/dataset/400x') # /vast/AI_team/dataset/stomach/patch/512/test/N" # "/vast/AI_team/sukmin/datasets/Task200_Stroma/imagesTs"
    parser.add_argument('-o', dest='aim_path', default="2022_400x_Stomach_UNet_b8_b") # Liver_UNet_b16_b # Stomach_N_UNet_b8_b
