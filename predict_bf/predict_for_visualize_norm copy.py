...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Stroma_norm')
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/Datasets_for_inference/2022_stomach_400x/images') # 2022_stomach_200x - Testset  # 2022_stomach_400x
    parser.add_argument('-o', dest='aim_path', default="400x_ResUNet_b32_norm_prep16_PN1:1_b") # 2018_200x_N_ResUNet_b32_norm_prep16_b
