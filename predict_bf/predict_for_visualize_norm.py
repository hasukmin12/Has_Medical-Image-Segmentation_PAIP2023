...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Stroma_norm')                                                             # 2022_stomach_400x
    ...
    parser.add_argument('-o', dest='aim_path', default="Test_CacoX_b32_DiceCE_b0.5k") # Test_ResUNet_b256_256_e06k  # 400x
    parser.add_argument('-n', dest='epoch_num', default='model_best_500.pth') # model_e15000.pth # model_best.pth
