    ...
    with torch.no_grad():
        for img_name in img_names:
            if img_name != 'Thumbs.db':
                ...
                # pre_img_data = normalizeStaining(img_data)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-t', dest='trainer', default='Test_Norm_Cellseg_StainNorm') # 'Stroma_NDM_100x_overlap')                                                             # 2022_stomach_400x
    parser.add_argument('-i', dest='input_path', default='/vast/AI_team/sukmin/datasets/Test_Norm/Cellseg/Test/Test_prep_StainNorm/images') # Task701_Lunit_Cell_only/For_inference/imagesTs  
    parser.add_argument('-o', dest='aim_path', default="Test_Norm_Cellseg_StainNorm_01250") # Test_200x_CacoX_b32_e45k  
    parser.add_argument('-n', dest='epoch_num', default='model_best_e01250_dice0.38351305966558.pth') # model_e06000.pth   # model_best_e09900.pth  # class_model_best_e10001.pth
