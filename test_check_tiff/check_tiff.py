...
def main():
    ...
    # default='/home/sukmin/datasets/Task010_NeurIPS_Cellseg/labelsTs'
    # '/home/sukmin/Results/rst_NeurIPS_Cellseg_semi_MKD'
    parser.add_argument('-gt_path', type=str, default='/vast/AI_team/sukmin/datasets/Task012_NeurIPS_Cellseg_tiff_format/labelsTs',help='path to ground truth; file names end with _label.tiff')
    parser.add_argument('-seg_path', type=str, default = '/vast/AI_team/sukmin/Results_NeurIPS_Challenge/rst_NeurIPS_Cellseg_semi_MKD_convnext_ASPPHead', help='path to segmentation results; file names are the same as ground truth')
    # parser.add_argument('--save_path', help='path where to save metrics')
    ...
    for name in tqdm(names):
        ...
        test = tif.imread('/vast/AI_team/sukmin/datasets/Train_Labeled/labels/cell_00025_label.tiff')
            # '/home/sukmin/SG_semi-mmseg_for_NeurIPS_Challenge/test_check_tiff/test_demo.tif')
        ...
        if np.prod(gt.shape)<25000000:
            ...
            test = remove_boundary_cells(test.astype(np.int32))
            print(gt.max())
            print(seg.max())
            print(test.max())           
