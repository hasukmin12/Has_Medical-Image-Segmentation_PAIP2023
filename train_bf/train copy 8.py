...
def main(info, config, logging=False):
    ...
    if info["FOLD_for_CrossValidation"] == False:
        ...
        while global_step < config["MAX_ITERATIONS"]:
            global_step, dice_val_best, steps_val_best, train_loss, train_dice = train(
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trainer', default= 'PAIP_2023_norm') # PAIP_2023_norm_CoDy # PAIP_2023_norm # Stroma_norm
