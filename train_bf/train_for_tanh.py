...
def main(info, config, logging=False):
    ...
    while global_step < config["MAX_ITERATIONS"]:
        global_step, dice_val_best, train_loss, train_dice_sup,  train_consistency = train(
...
if __name__ == "__main__":
    ...
    parser.add_argument('-trainer', default='Stroma_tanh') # Neurips_Cellseg # Liver # Carotid_side
