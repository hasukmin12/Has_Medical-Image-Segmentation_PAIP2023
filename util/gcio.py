...
class DataLoader:
    ...
    def __init__(self, cell_path, tissue_path):
        cell_fpath = [os.path.join(cell_path, f) for f in os.listdir(cell_path) if ".jpg" in f]
        tissue_fpath = [os.path.join(tissue_path, f) for f in os.listdir(tissue_path) if ".jpg" in f]
